...
//handler in that class. The handler should send the WM_IDLEUPDATECMDUI message 
//on to the dialog child windows by using CWnd::SendMessageToDescendants(). 
//Then perform default processing for the message within the frame window. 
