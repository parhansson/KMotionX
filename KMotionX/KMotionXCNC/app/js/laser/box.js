...
SVGBox.prototype.MitrePanel = function(x, y, w, h, corner_size,  div_x, div_y, thick, invertX, invertY) {
...
SVGBox.prototype.PolyStart = function() {
  this.svg += ("<polyline points=\"");
  this.polyFirst = true;
}

SVGBox.prototype.PolyPoint = function(x, y) {
   if(!this.polyFirst)
     this.svg += " ";
...
SVGBox.prototype.PolyEnd = function() {
  this.svg += ("\" fill=\"none\" stroke=\"black\" stroke-width=\"3\" />\r\n");
}
SVGBox.prototype.StartDoc = function(w, h) {
  var res = 100;
  //w = (w+(99))/100*100;
  //w = (w+(res-1))/res*res;
  //h = (h+(res-1))/res*res;
...
SVGBox.prototype.EndDoc = function() {
  this.svg += ("</svg>\r\n");
}
