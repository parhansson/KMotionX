...
class GCodeLineStyler implements LineStyleListener {
  GCodeScanner scanner = new GCodeScanner();
  ...
  public GCodeLineStyler() {
    initializeColors();
    scanner = new GCodeScanner();
  }
  ...
  public class GCodeScanner {
    ...
    private String[] fgKeywords = { "BUF", "MSG", "USR"};
