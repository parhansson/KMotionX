...
//******************************************************************
// Limit switches
#define X_Axis_Home_Switch 			1024
#define Y_Axis_Home_Switch 			1025
#define Z_Axis_Home_Switch 			1026
#define Probe_Switch 				1027
#define Movable_Toolsetter_Switch 	1028
#define Fixed_Toolsetter_Switch 	1029
#define E_Stop_Switch 	            1030
...
float Move_To_From_Switch(int Axis, int Switch, int To_From, float Feed, float Overtravel)
{
	...
	// fakeout hardware tktk
	Delay_sec(2);
	Jog(Axis,0.0);
	while (!CheckDone(Axis)) ;
	return chan[Axis].Dest / Z_Counts_Per_Inch;	
