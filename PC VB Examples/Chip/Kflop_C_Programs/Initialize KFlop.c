...
int main() 
{
	...
	ch0->BacklashRate=0;
	ch0->invDistPerCycle=250; // 250 cycles is one rev = 0.004 inches, with microstepping one count = 0.004/16 =0.00025 in
	ch0->Lead=0;
	...
	ch1->BacklashRate=0;
	                           // 250 cycles is one rev = 0.004 inches, with microstepping one count = 0.004/16 =0.00025 in
	ch1->invDistPerCycle=250; // One rev = 0.004 inches, DistPerCycle = 1/0.004     Screw lead is 5 revs per inch, 1 rev = 0.2 in.
	ch1->Lead=0;
	...
	ch2->BacklashRate=0;
	ch2->invDistPerCycle=254;  // One rev = 5mm or 0.19685039 in, DistPerCycle = 1/0.19685039
	ch2->Lead=0;
